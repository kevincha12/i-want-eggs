...
def load_walmart_csvs():
    ...
    walmart_store_location = pd.read_csv('./data/walmart_store_locaction.csv', encoding='latin1')
...
def load_target_csvs():
    ...
    target_store_location = pd.read_csv('./data/Target datasets.csv', encoding='latin1')
